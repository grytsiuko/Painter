...
# Form implementation generated from reading ui file 'src/gui/gui_root.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("img/pencil.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.buttonGroup.addButton(self.pencil_button)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("img/layer-shape-ellipse.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.oval_button.setIcon(icon1)
        self.oval_button.setIconSize(QtCore.QSize(36, 36))
        self.oval_button.setObjectName("oval_button")
        self.buttonGroup.addButton(self.oval_button)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("img/eraser.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.buttonGroup.addButton(self.eraser_button)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("img/paint-can.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.can_button.setIcon(icon3)
        self.can_button.setIconSize(QtCore.QSize(36, 36))
        self.can_button.setObjectName("can_button")
        self.buttonGroup.addButton(self.can_button)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("img/layer-shape-line.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("img/paint-brush.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.buttonGroup.addButton(self.brush_button)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("img/spray.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.buttonGroup.addButton(self.spray_button)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("img/pipette.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.buttonGroup.addButton(self.pipette_button)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("img/layer-shape.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("img/edit.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.text_button.setIcon(icon9)
        self.text_button.setIconSize(QtCore.QSize(36, 36))
        self.text_button.setObjectName("text_button")
        self.buttonGroup.addButton(self.text_button)
        ...
        self.frame_2.setMinimumSize(QtCore.QSize(211, 251))
...
"border-radius: 10px;")
        ...
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(20, 70, 171, 161))
        self.gridLayoutWidget_2.setObjectName("gridLayoutWidget_2")
        self.gridLayout_2 = QtWidgets.QGridLayout(self.gridLayoutWidget_2)
        self.gridLayout_2.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.size_label = QtWidgets.QLabel(self.gridLayoutWidget_2)
        self.size_label.setObjectName("size_label")
        self.gridLayout_2.addWidget(self.size_label, 0, 0, 1, 1)
        self.font_label = QtWidgets.QLabel(self.gridLayoutWidget_2)
        ...
        self.gridLayout_2.addWidget(self.font_button, 2, 1, 1, 2)
        self.filled_label = QtWidgets.QLabel(self.gridLayoutWidget_2)
        self.filled_label.setObjectName("filled_label")
        self.gridLayout_2.addWidget(self.filled_label, 1, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.filled_check, 1, 1, 1, 2)
        self.text_label = QtWidgets.QLabel(self.gridLayoutWidget_2)
        self.text_label.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.text_label.setObjectName("text_label")
        self.gridLayout_2.addWidget(self.text_label, 3, 0, 1, 1)
        self.text_edit = QtWidgets.QLineEdit(self.gridLayoutWidget_2)
        self.text_edit.setObjectName("text_edit")
        self.gridLayout_2.addWidget(self.text_edit, 3, 1, 1, 2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.filled_label.setText(_translate("MainWindow", "Filled"))
