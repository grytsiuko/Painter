...
"border-radius: 10px;")
        ...
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(20, 80, 272, 104))
        ...
        self.font_picker = QtWidgets.QFontComboBox(self.gridLayoutWidget_2)
        self.font_picker.setObjectName("font_picker")
        self.gridLayout_2.addWidget(self.font_picker, 1, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.filled_check, 2, 1, 1, 1)
        ...
        self.scrollAreaWidgetContents_6.setGeometry(QtCore.QRect(0, 0, 758, 712))
