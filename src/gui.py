...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.toolButton.setGeometry(QtCore.QRect(70, 20, 71, 41))
        self.toolButton.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.toolButton.setAutoFillBackground(False)
        self.toolButton.setStyleSheet("background-color: #000;\n"
"border-radius: 10px;")
        self.toolButton.setText("")
        self.toolButton.setObjectName("toolButton")
        self.gridLayoutWidget_2 = QtWidgets.QWidget(self.frame_2)
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(20, 80, 171, 104))
